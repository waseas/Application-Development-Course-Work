...
public class Main {
    public static void main(String[] args) {
        ...
        if ( option == 1){
            ...
            System.out.println("------------------------------------------------");
            System.out.println("\nDo you want to check perticular vital sign level ?");
            ...
            System.out.println("------------------------------------------------");
            if((vitalSigns.getAgeGroup()>=0 && vitalSigns.getAgeGroup()<0.12)){
                System.out.println("\nPatient is a newborn Baby");
            }
            else if((vitalSigns.getAgeGroup()>=0.12 && vitalSigns.getAgeGroup()<1)){
                System.out.println("\nPatient ia an Infant (1-12 Months)");

            }
            else if((vitalSigns.getAgeGroup()>=1 && vitalSigns.getAgeGroup()<3)){
                System.out.println("\nPatient ia a Toddler (1-3 Years)");

            }
            else if((vitalSigns.getAgeGroup()>=3 && vitalSigns.getAgeGroup()<=5)){
                System.out.println("\nPatient is a Preschooler (3-5 Years)");

            }
            else if((vitalSigns.getAgeGroup()>=6 && vitalSigns.getAgeGroup()<=12)){
                System.out.println("\nPatient is in School Age (6-12 Years)");

            }
            else if(vitalSigns.getAgeGroup()>=13 && (vitalSigns.getAgeGroup()<=100)){
                System.out.println("\nPatient is an Adolescent (13+ Years)");
